...
public class vw_PontuaisCinzahdtv extends JDialog {

	public vw_PontuaisCinzahdtv(ArrayList<JInternalFrame> frames) {
		setTitle("Cinza HDTV");
		...
		JLabel lblIntro = new JLabel("Selecione a imagem que ficará em Cinza HDTV");
		...
		btnOk.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				for (int i = 0; i < frames.size(); i++) {
					...
					if (imagem1 != null) {
						Imagem result = Pontuais.cinzaHDTV(imagem1);
