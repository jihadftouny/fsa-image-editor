...
public class vw_FiltrosMedia4 extends JDialog {

	public vw_FiltrosMedia4(ArrayList<JInternalFrame> frames) {
		setTitle("Média 4");
		...
		JLabel lblIntro = new JLabel("Selecione a imagem que realizará a Média 4");
		...
		btnOk.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				for (int i = 0; i < frames.size(); i++) {
					...
					if (imagem1 != null) {
						Imagem result = Filtros.media4(imagem1);
