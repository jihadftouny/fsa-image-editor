...
public class vw_PontuaisCinzantsc extends JDialog {

	public vw_PontuaisCinzantsc(ArrayList<JInternalFrame> frames) {
		setTitle("Cinza NTSC");
		...
		JLabel lblIntro = new JLabel("Selecione a imagem que ficará em Cinza NTSC");
		...
		btnOk.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				for (int i = 0; i < frames.size(); i++) {
					...
					if (imagem1 != null) {
						Imagem result = Pontuais.cinzaNTSC(imagem1);
