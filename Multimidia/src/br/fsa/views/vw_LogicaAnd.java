...
public class vw_LogicaAnd extends JDialog {

	public vw_LogicaAnd(ArrayList<JInternalFrame> frames) {
		setTitle("AND");
		...
		JLabel lblIntro = new JLabel("Selecione as imagens que farão o AND");
		...
		JLabel lblOperacao = new JLabel("AND");
			...
			public void actionPerformed(ActionEvent e) {
				...
				for (int i = 0; i < frames.size(); i++) {
					...
					if (imagem1 != null && imagem2 != null) {
						Imagem result = Logica.and(imagem1, imagem2);
