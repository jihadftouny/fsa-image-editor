...
public class vw_PontuaisCinzahdr extends JDialog {

	public vw_PontuaisCinzahdr(ArrayList<JInternalFrame> frames) {
		setTitle("Cinza HDR");
		...
		JLabel lblIntro = new JLabel("Selecione a imagem que ficará em Cinza HDR");
		...
		btnOk.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				for (int i = 0; i < frames.size(); i++) {
					...
					if (imagem1 != null) {
						Imagem result = Pontuais.cinzaHDR(imagem1);
