...
public class vw_LogicaNot extends JDialog {

	public vw_LogicaNot(ArrayList<JInternalFrame> frames) {
		setTitle("NOT");
		...
		JLabel lblIntro = new JLabel("Selecione a imagem que fará o NOT");
		...
		btnOk.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				for (int i = 0; i < frames.size(); i++) {
					...
					if (imagem1 != null) {
						Imagem result = Logica.not(imagem1);
