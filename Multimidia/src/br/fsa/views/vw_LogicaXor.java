...
public class vw_LogicaXor extends JDialog {

	public vw_LogicaXor(ArrayList<JInternalFrame> frames) {
		setTitle("XOR");
		...
		JLabel lblIntro = new JLabel("Selecione as imagens que farão o XOR");
		...
		JLabel lblOperacao = new JLabel("XOR");
			...
			public void actionPerformed(ActionEvent e) {
				...
				for (int i = 0; i < frames.size(); i++) {
					...
					if (imagem1 != null && imagem2 != null) {
						Imagem result = Logica.xor(imagem1, imagem2);
