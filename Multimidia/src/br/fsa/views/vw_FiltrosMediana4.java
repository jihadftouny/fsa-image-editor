...
public class vw_FiltrosMediana4 extends JDialog {

	public vw_FiltrosMediana4(ArrayList<JInternalFrame> frames) {
		setTitle("Mediana 4");
		...
		JLabel lblIntro = new JLabel("Selecione a imagem que realizará a Mediana 4");
		...
		btnOk.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				for (int i = 0; i < frames.size(); i++) {
					...
					if (imagem1 != null) {
						Imagem result = Filtros.mediana4(imagem1);
